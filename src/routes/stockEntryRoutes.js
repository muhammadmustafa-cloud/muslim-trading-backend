...
router.post('/', protect, upload.array('images', 10), asyncHandler(stockEntryController.create));
router.put('/:id', protect, superAdminOnly, upload.array('images', 10), asyncHandler(stockEntryController.update));
